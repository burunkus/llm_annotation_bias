...
def main():
    path = PATH
    train_dataset = path + "hateval2019/hateval2019_en_train_preprocessed_dialect_label.txt"
    test_dataset = path + "hateval2019/hateval2019_en_test_preprocessed_dialect_label.txt"
    ...
    dataset_name = "hateval" # Change to the name of the dataset - hateval, waseem etc this is for folder naming purposes
