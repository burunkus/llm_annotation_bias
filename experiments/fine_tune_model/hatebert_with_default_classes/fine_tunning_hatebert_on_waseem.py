...
def main():
    path = PATH
    train_dataset = path + "waseem/waseem_with_default_classes_train_preprocessed_dialect_label.txt"
    test_dataset = path + "waseem/waseem_with_default_classes_test_preprocessed_dialect_label.txt"
    ...
    dataset_name = "waseem" # Change to the name of the dataset - hateval, waseem etc this is for folder naming purposes
