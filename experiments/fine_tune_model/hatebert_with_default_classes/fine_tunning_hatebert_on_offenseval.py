...
def main():
    path = PATH
    train_dataset = path + "offenseval2019/offenseval_train_preprocessed_dialect_label.txt"
    test_dataset = path + "offenseval2019/offenseval_test_preprocessed_dialect_label.txt"
    ...
    dataset_name = "offenseval" # Change to the name of the dataset - hateval, waseem etc this is for folder naming purposes
