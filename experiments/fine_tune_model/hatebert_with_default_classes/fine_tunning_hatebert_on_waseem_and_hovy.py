...
def main():
    path = PATH
    train_dataset = path + "waseem-and-hovy/waseem_and_hovy_with_default_classes_train_preprocessed_dialect_label.txt"
    test_dataset = path + "waseem-and-hovy/waseem_and_hovy_with_default_classes_test_preprocessed_dialect_label.txt"

    # Path where the pre-trained model and tokenizer can be found
    model_path = "../../../../../../project/luofeng/socbd/eokpala/hate_bert"
    tokenizer_path = "../../../../../../project/luofeng/socbd/eokpala/hate_bert"
    dataset_name = "waseem_and_hovy" # Change to the name of the dataset - hateval, waseem etc this is for folder naming purposes
    base_model = "HateBERT" # Change to BERT/RoBERTa if thats the model I am fine-tunning on
    save_path = SAVE_PATH + f"hate_bert/{base_model}_fine_tuned_on_{dataset_name}/"
