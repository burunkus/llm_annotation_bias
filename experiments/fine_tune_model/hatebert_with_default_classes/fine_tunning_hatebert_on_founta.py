...
def main():
    path = PATH
    train_dataset = path + "founta/founta_with_default_classes_train_preprocessed_dialect_label.txt"
    test_dataset = path + "founta/founta_with_default_classes_test_preprocessed_dialect_label.txt"
    ...
    dataset_name = "founta" # Change to the name of the dataset - hateval, waseem etc this is for folder naming purposes
