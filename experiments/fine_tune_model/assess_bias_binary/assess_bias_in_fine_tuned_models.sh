...
#SBATCH --output /home/eokpala/llm_annotation_bias/experiments/fine_tune_model/assess_bias_binary/logs/assess_bias_in_fine_tuned_models_out.txt
#SBATCH --error /home/eokpala/llm_annotation_bias/experiments/fine_tune_model/assess_bias_binary/logs/assess_bias_in_fine_tuned_models_err.txt
#SBATCH --nodes 1
